...
//	}
	...
	self.creditsButton.title = NSLocalizedString(@"Donate", @"");
...
-(void) showCredits:(id)sender {
    [[NSWorkspace sharedWorkspace] openURL:[NSURL URLWithString:@"https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=3LKD2KVRRBBZ4"]];
